...
class SoftMuPatchMerging(nn.Module):
    ...
    def forward(self, x,text):
        ...
        x=self.qdatt(x,text)    #multi modal multiscal fusion
...
class NoFpnSoftDownSample(nn.Module):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_outs,
    ...
    def forward(self, inputs, text):
        ...
        laterals = [
            ...
            for i, lateral_conv in enumerate(self.lateral_convs)    #1*1 conv to same dimension
        ]
